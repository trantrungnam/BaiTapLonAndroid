 ...
 */
public class Dialog_With_Config_Quantity extends DialogFragment {

    private EditText edtQuantity;
    public View c;

    public Dialog_With_Config_Quantity(View c) {
        this.c = c;
    }
...
//                    bundle.putInt("quantity", quant);
                    ...
                    List<Bill_Food> cleanBill = new ArrayList<Bill_Food>();
                    for (Bill_Food billFood: bill_foodList){
                        if(billFood.getQuantity() != 0) {
                            cleanBill.add(billFood);
                        }
                    }

                    Bill_Food_List_Type bill_food_list_type = new Bill_Food_List_Type();
                    bill_food_list_type.setFoodList(cleanBill);
